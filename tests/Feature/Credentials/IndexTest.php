...
todo('an authenticated user gets the correct status code.');
todo('an authenticated user can only see their own resources.');
todo('the response comes in a standard format.');
